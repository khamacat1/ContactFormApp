...
# Private subnets — one per AZ. EKS worker nodes and RDS live here, with
# no public IPs and no direct inbound path from the internet.
...
# one per AZ, and this project doesn't need AZ-level fault tolerance for
# outbound internet access. Every private subnet routes through this one.
